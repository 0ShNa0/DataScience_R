...
plt_cum_confirmed_cases_china_vs_world <- ggplot(data=confirmed_cases_china_vs_world,aes(x=date,y=cum_cases,group=1)) +
  geom_line(aes(date,cum_cases,color=is_china),size=1.2) +
  ylab("Cumulative confirmed cases")
...
ggplot(data=confirmed_cases_top7_outside_china,aes(date,cum_cases,color=country))+
geom_line()+
ylab("Cumulative confirmed cases")
